    ...
    <header className="bg-">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 text-[#872341] lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Link to="/vendor/profile" className="text-base font-bold leading-6 text-[#872341]">
          profile
          </Link>
          <Link to="/vendor/studio" className="text-base font-bold leading-6 text-[#872341]">
          studio
          </Link>
          <Link to="/vendor/profile" className="text-base font-bold leading-6 text-[#872341]">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          ...
          <a href="#" onClick={confirmLogout} className="text-base font-bold leading-6 text-[#872341]">
      ...
      <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="font-MyFont text-3xl text-[#872341]">SnapShot</span>
              <img
